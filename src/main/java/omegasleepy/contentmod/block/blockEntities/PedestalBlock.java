package omegasleepy.contentmod.block.blockEntities;
...
import omegasleepy.contentmod.block.entity.ATMBlockEntity;
...
public class PedestalBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public ActionResult onUse (BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if(!world.isClient) {
            NamedScreenHandlerFactory screenHandlerFactory = (ATMBlockEntity)world.getBlockEntity(pos);
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker (World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.ATM_BLOCK_ENTITY,
